...
export const html5Games: Html5Game[] = [
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Merge ores to upgrade your mine. Click to mine, drag to merge. Idle gameplay.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Ten balls, precise shooting. Physics-based, hit more balls to score.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Draw lines to guide the ball. Physics puzzles, creative solutions.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Pour water to fill the glass. Angle and liquid physics. Precision control.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Spin and hit the target. Perfect angle, perfect shot. One-shot precision.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Zombies are coming, survive! Upgrade weapons, fight waves. Last stand action.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Untangle the ropes. Logic puzzle, step by step. Find the solution.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Pinball action. Knock down pins, score big. Classic arcade feel.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Practice English pronunciation. Record, compare, improve. Educational speaking app.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Classic shooting gallery. Aim, shoot, score. Practice makes perfect.',
    controls: 'Mouse to aim, click to shoot',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Throw knives at targets. Precision throwing. Hit the bullseye every time.',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Stack falling balls. Same color passes through, different color stacks. How high can you go?',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Temple run collecting strawberries. Run, jump, dodge obstacles. Sweet endless runner.',
    controls: 'Tap to jump',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: '3D free kick challenge. Angle, curve, power. Master the perfect kick.',
    controls: 'Swipe to shoot',
  ...
  },
  {
    ...
    developer: 'GamePix',
    description: 'Virtual darts. Aim for the bullseye, account for wind. One dart to win.',
